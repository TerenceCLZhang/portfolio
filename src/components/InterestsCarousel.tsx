      ...
      <CarouselContent>
        {interests.map((item, index) => (
          <CarouselItem
            ...
            key={index}
          >
            <div className="flex flex-col items-center justify-center border-3 border-gray-400 rounded-xl py-2 px-5 h-20 bg-gray-700 text-lg font-semibold text-white text-center">
